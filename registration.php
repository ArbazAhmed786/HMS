...
$query="insert into user values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$dob',now(),'$pmob','$fname','$mname','$bg')";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input  class="form-control" type="number" name="pmob" id="phone" required/></td>
				</tr>
